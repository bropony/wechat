#ifndef _CDF_EXCEPTION_H_
#define _CDF_EXCEPTION_H_
...
namespace gamit
{
	...
	enum ECDEErrorCodeSystem
	{
		...
		ExceptionCodenullptrHandle = 10006,  //nullptr handle exception
	...
	class CnullptrHandleException : public CException
	{
	public :
		CnullptrHandleException(const char* file , int nline);
		virtual ~CnullptrHandleException();
	};

#define G_THROW_EXCEPTION( E , STR ) \
	{ \
...
#define G_THROW_CODE_EXCEPTION( E , CODE , STR ) \
	{ \
	std::ostringstream stream;\
	stream << STR ; \
